...
def normalise_input(user_input):
    ...
    norm_words = remove_punct(user_input).lower()

    norm_words = norm_words.split()

    norm_words = filter_words(norm_words, skip_words)
